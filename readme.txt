...
1. Program have the ability to search any level of degree of separation. But restricted to 3 level of degree.
...
- Recursive backward trace with respect to the parent element for finding the shortest degree.
